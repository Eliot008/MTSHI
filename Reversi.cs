...
namespace Reversi
{
	...
	public class ReversiForm : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.currentColorTextLabel.Size = new System.Drawing.Size(55, 16);
            this.currentColorTextLabel.TabIndex = 4;
            this.currentColorTextLabel.Text = "Зараз: ";
            ...
            this.blackTextLabel.Text = "Чорні: ";
            // 
            // moveListView
            // 
            ...
            this.resignGameMenuItem.Text = "&Продовжити гру";
            ...
            this.optionsMenuItem.Text = "&Опції...";
            ...
            this.undoMoveMenuItem.Text = "&Відмінити хід,";
            ...
            this.redoMoveMenuItem.Text = "&Повторити хід";
            ...
            this.undoAllMovesMenuItem.Text = "В&ідмінити всі ходи";
            ...
            this.redoAllMovesMenuItem.Text = "П&овторити всі ходи";
            ...
            this.resumePlayMenuItem.Text = "Продовжити &гру";
            ...
            this.helpTopicsMenuItem.Text = "&Теми";
            ...
            this.statusProgressBar.Location = new System.Drawing.Point(326, 2);
            this.statusProgressBar.Name = "statusProgressBar";
            this.statusProgressBar.Size = new System.Drawing.Size(125, 19);
            ...
            this.newGameToolBarButton.ToolTipText = "Нова гра";
            // 
            ...
            this.resignGameToolBarButton.ToolTipText = "Скинути гру";
            // 
            ...
            this.undoAllMovesToolBarButton.ToolTipText = "Відмінити всі ходи";
            // 
            ...
            this.undoMoveToolBarButton.ToolTipText = "Відмінити хід";
            // 
            ...
            this.resumePlayToolBarButton.ToolTipText = "Продовжити гру";
            // 
            ...
            this.redoMoveToolBarButton.ToolTipText = "Повторити хід";
            // 
            ...
            this.redoAllMovesToolBarButton.ToolTipText = "Повторити всі ходи";
            // 
            // playImageList
            // 
		...
		private void EndGame(bool isResignation)
		{
			...
			if (isResignation)
			{
				...
				// message.
				if (this.IsComputerPlayer(Board.Black) && this.IsComputerPlayer(Board.White))
					this.statusLabel.Text = "Гра зупинена.";
				else
				{
					...
					{
						this.statusLabel.Text = "Чорні скидуються.";
						this.statistics.Update(0, 64, computerColor, userColor);
					}
					else
					{
						this.statusLabel.Text = "Білі скидуються.";
			...
			else
			{
				...
				if (this.board.BlackCount > this.board.WhiteCount)
					this.statusLabel.Text = "Чорні перемогли.";
				else if (this.board.WhiteCount > this.board.BlackCount)
					this.statusLabel.Text = "Білі перемогли.";
				else
					this.statusLabel.Text = "Нічия.";
		...
		private void StartTurn()
		{
			...
			string playerText = String.Format("{0}", (this.currentColor == Board.Black ? "Чорні" : "Білі"));
			if ((this.options.ComputerPlaysBlack && !this.options.ComputerPlaysWhite) ||
				...
				playerText = (this.IsComputerPlayer(this.currentColor) ? "Мій" : "Твій");
			...
			if (this.IsComputerPlayer(this.currentColor))
			{
				...
				if (this.isComputerPlaySuspended)
				{
					...
					this.statusLabel.Text = String.Format("{0} хід... (Припинено, натисніть {1} щоб продовжити гру.)", playerText, shortCutText);
					this.statusProgressBar.Visible = false;
				}
				else
				{
					// Set the status display.
					this.statusLabel.Text = String.Format("{0} хід, думає... ", playerText);
			...
			else
			{
				...
				// Update the status display.
				this.statusLabel.Text = String.Format("{0} хід...", playerText);
				this.statusProgressBar.Visible = false;
		...
		private void ReversiForm_Closing(object sender, System.ComponentModel.CancelEventArgs e)
		{
			...
			if (this.gameState != ReversiForm.GameState.GameOver)
			{
				...
				ConfirmDialog dlg = new ConfirmDialog("Вийти?");
		...
		private void resignGameMenuItem_Click(object sender, System.EventArgs e)
		{
			...
			{
				// Create and show the confirm dialog, saving the result.
				ConfirmDialog dlg = new ConfirmDialog("Скинути цю гру?");
				if (dlg.ShowDialog(this) != DialogResult.Yes)
					doEnd = false;
		...
		private void helpTopicsMenuItem_Click(object sender, System.EventArgs e)
		{
			...
			if (fileInfo.Exists)
				...
				MessageBox.Show(this,
					String.Format("Файл допомоги '{0}' не знайдено.", ReversiForm.helpFileName),
					"File Not Found",
